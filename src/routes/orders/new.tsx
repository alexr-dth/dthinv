  ...
  return (
    <>
      ...
      <div className="page-container">
        ...
        <h2 className="page-title">Create Order Ticket</h2>
...
const PendingRequestedCard = ({ data: item, requestedBy }) => {
  const [expanded, setExpanded] = useState(false)
    ...
    <div className="mt-2">
      <div className="flex items-stretch gap-2 mb-1">
        <label className="w-1/4" htmlFor={id}>
          <img src={'/wrench.jpg'} alt="" className="object-contain" />
        </label>
...
const RequestedCreateCard = ({ data: item, setActiveModal }) => {
  const [expanded, setExpanded] = useState(false)
  return (
    <div className="mt-2">
      <div className="flex items-stretch gap-2 mb-1">
            ...
            <div className="flex-1">
              ...
              <div className="text-nowrap font-semibold text-sm">
                ...
                <button
                  ...
                  onClick={() =>
                    setActiveModal({ name: 'editRequested', data: {} })
                  }
                >
                  Edit
                </button>
...
const AddRequestedModal = ({ confirmCallback, cancelCallback }) => {
  return (
    <div className="bg-white rounded p-3 mx-3">
      <div className="mb-3 flex justify-between items-center">
        <h3 className="font-semibold text-xl">Requested Items [Home Depot]</h3>
      </div>
